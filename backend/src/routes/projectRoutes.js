...
router.get('/', authenticate, requirePermission('projects.read'), asyncHandler(projectController.listProjects));
router.get('/:id', authenticate, requirePermission('projects.read'), asyncHandler(projectController.getProject));
router.post('/', authenticate, requirePermission('projects.create'), asyncHandler(projectController.createProject));
router.put('/:id', authenticate, requirePermission('projects.update'), asyncHandler(projectController.updateProject));
